...
if __name__ == '__main__':
    ...
    trainset = torchvision.datasets.CIFAR100(root='./cifar100', train=True, transform=train_transform, download=True)
    ...
    if args.use_info_batch:
        ...
        train_shuffle = False
    testset = torchvision.datasets.CIFAR100(root='./cifar100', train=False, download=True, transform=test_transform)
